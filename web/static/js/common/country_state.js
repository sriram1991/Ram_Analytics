//------------------------------------------------//
//| All Countrys and State Dorp-Down List By USK |//
//------------------------------------------------// 
...
function populateCountries(countryElementId, stateElementId) {
    ...
    var stateThis = document.getElementById(stateElementId);
    stateThis.options[0] = new Option('Select State', '');
