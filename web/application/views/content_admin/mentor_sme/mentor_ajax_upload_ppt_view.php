<form method="post" action="#" id="ajax_ppt_upload" name="ajax_ppt_upload">
	<div class="row">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="form-group control-group">
                <div class="control">
                    <input type="file" required autocomplete="off" name="resource_ppt_link" id="resource_ppt_link" class="form-control input" placeholder="Select File" tabindex="3"> 
                </div>
                <span class="help-block"></span>
            </div>
        </div>
    ...
    <input id="file_type" type="hidden" value="PPT">
<!-- <input type="file" name="userfile" id="userfile" size="20" /> -->
</form>
<script src="/static/js/common/ajaxfileupload.js"></script>
<script src="/static/js/common/ajax_ppt_file_upload.js"></script>
