                        ...
                        <div class="sometype">
                            ...
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-primary ion-university" data-toggle="modal" data-target="#mentor_assessment_modal" onClick="ajax_mentor_assessment_modal();">
                                  Add Assessment
                        ...
                        <div class="box">
                            ...
                            <div class="box-body table-responsive">
                                ...
                                <table id="mentor_assessment_list" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>SL.NO</th>
                                            <th>Test No</th>
                                                    ...
                                                    switch ($role_id) {
                                                        case '6':
                                                            return "
                                                                    ...
                                                                    <button type='button' class='btn-sm btn-info' onClick='edit_mentor_assessment_modal(".$res_test_id.");'><i class='glyphicon glyphicon-edit text-white'></i></button> 
                                                                   ";
                                                            break;
                                                        case '7':
                                                            return "
                        ...
                        <!-- ============= ADD Mentor Assessment Modal =========== -->

                        <div class="modal fade" id="mentor_assessment_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg  ">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" onClick="$('.input').val('');">
                                    ...
                                    <div class="modal-body" id="body-add_mentor_assessment">
                                        <!-- AJAX Call Will Load Assessment Modal -->
                                    </div>
                                    
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-success" onClick="upload_ass_pdf('#ajax_mentor_assessment_upload');" id="mentor_assessment_pdf" data-loading-text="Processing..." >Add Assessment</button>
                                        <button type="button" class="btn btn-danger" data-dismiss="modal" onClick="$('.input').val('');">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- ============= EDIT Mentor Assessment Modal start=========== -->

                        <div class="modal fade" id="edit-mentor_assessment_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg  ">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" onClick="$('.input').val('');">
                                    ...
                                    <div class="modal-body" id="body-edit_mentor_assessment">
                                        <!-- AJAX Call Will Load Edit Assessment Modal -->
                                    </div>
                                    
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-success edit_assessment_btn" onClick="update_mentor_assessment();" >Save Changes</button>
                                        <button type="button" class="btn btn-warning edit_assessment_btn" onClick="$('.input').val('');">Reset</button>
                                        <button type="button" class="btn btn-danger edit_assessment_btn" data-dismiss="modal" onClick="$('.input').val('');">Cancel</button>
                                        <button type='button' class='btn btn-danger close_assessment_btn' data-dismiss='modal'>Close</button>
                                    </div>
                        ...
                        <!-- ============= EDIT Mentor Assessment Modal end =========== -->