                                    ...
                                    <?php
                                        if($course_details!= null){
                                            foreach ($course_details as $res) {
                                                echo "<li role='presentation'><a href='#' role='menuitem' tabindex='-1' onClick='get_course_resource_map_list(".$res->course_id.");'>".$res->course_name."</a></li>";
                                            }    
                                        } else {
                        ...
                        <br>
                        <div id="cres_map_list" class="box">
                            <!-- AJAX Call Will Fill Syllabus List -->
                            <div class="box-header">
                                <?php
                                    if($course_details!= null){
                                        echo "<h3 class='text-center'><p><br><br><br>Please select a course to map Course & Resource </p><br><br><br></h3>";        
                                    } else {
