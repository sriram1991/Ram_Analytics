        ...
        <section class="content">
            <div class="content-header">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="btn-group" role="group">
                            <button type="button" id="avail_aoi_btn" class="btn btn-primary dropdown-toggle ion-university" data-toggle="dropdown" aria-expanded="false">
                              Area of Interest
                            ...
                            <ul class="dropdown-menu scrollable-menu" role="menu">
                                <?php
                                    if(isset($avail_aoi)){
                                        foreach ($avail_aoi as $res) {
                                            echo "<li role='presentation'><a href='#' role='menuitem' tabindex='-1' onClick='get_available_aoi_courses(\"$res->subject_name\");'>".$res->subject_name."</a></li>";
                                        }    
                                    } else {
                ...
                <div class="row" id="availavle_aoi_courses">
                <?php 
                /*
                $AV_flag = true;
                ...
                */
                echo "<center><h4> Please Select Area of Interest to Display Courses !</h4></center>";
                ?>
                </div>
                </fieldset>
            </div>
            ...
            if(isset($my_courses)){
                ...
                <legend>My Paid Courses</legend>";
                    ...
                    echo '<div class="col-md-5">
                            <div class="btn-group" role="group">
                            <button type="button" id="paid_aoi_btn" class="btn btn-primary dropdown-toggle ion-university" data-toggle="dropdown" aria-expanded="false">
                              Area of Interest
                              <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu scrollable-menu" role="menu">';
                            if(isset($paid_aoi)){
                                foreach ($paid_aoi as $res) {
                                    echo "<li role='presentation'><a href='#' role='menuitem' tabindex='-1' onClick='get_paid_aoi_courses(\"$res->subject_name\");'>".$res->subject_name."</a></li>";
                                }    
                            } else {
                                echo "<li role='presentation' class='disabled'><a href='#' role='menuitem' tabindex='-1'>Please select a AOI </a></li>";         
                            }
                    ...
                    echo "<div class='row' id='paid_aoi_courses'>";
                    /*
                    if(isset($my_courses)){
                        $pc_flag = true;
