        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                 <?php 
                    ...
                    echo "<li><a href='#' onClick='get_course_menu(".$course_id."); get_course_modules(".$course_id.");'><i class='fa fa-dashboard'></i>".$course_details['course_name']."</a></li>"; 
                        ...
                        foreach ($course_subject as $res) {
                            ...
                            $small_box  = "
                                <div class='small-box bg-purple'
                                     ...
                                     data-subject_name=".htmlspecialchars($title)."
                                     onClick='get_cmgs_resources(this.getAttribute(\"data-course_id\"),this.getAttribute(\"data-subject_name\"));' >
                                    <div class='inner'><h4>".$title."</h4><p>".$module_name."</p></div>
                            ...
                            echo "
                                <div class='small-box bg-purple'
                                     onClick='get_cmgs_resources(\"$course_id\",\"$title\");' >
                                    <div class='inner'><h4>".$title."</h4><p>".$module_name."</p></div>
                                    <div class='icon'><i class='ion-social-rss'></i></div>
                                    <a href='#'' class='small-box-footer'>Start Learning <i class='fa fa-arrow-circle-right'></i></a>
                                </div>    
