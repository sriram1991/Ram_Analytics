...
<div class="container"><!-- /.container -->
	<div class="starter-template">
		<form name="BasicForm" id="BasicForm" method="POST" action="/student/SH_Controller/Update_profile" role="form">
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                       <div class="form-group control-group">
                                           <div class="control input-group">
                                              <input type="text" value="<?php echo $user_details['user_city']; ?>"autocomplete="off" name="city" id="city" class="form-control input" placeholder="City" tabindex="7">
                                            </div>
                                         <span class="help-block"></span>
                                       </div>
                                    </div>
                                 ...
                                 <div class="row">
						                ...
						                <div class="col-xs-12 col-sm-6 col-md-4">
						                  <div class="form-group control-group">
						                      <div class="control">
						                      <input type="text"  value="<?php echo $user_details['user_district']; ?>"autocomplete="off" name="district" id="district" class="form-control input" placeholder="district" tabindex="8">
						                      </div>
						                      <span class="help-block"></span>
						                  </div>
						                </div>
						                ...
						                <div class="col-xs-12 col-sm-6 col-md-4">
						                  <div class="form-group control-group">
										      ...
										      <div class="row">
										            ...
										            <button type="submit" onClick="doSubmit('#BasicForm');" class="btn btn-success"> Update </button tabindex="12">
										          </div>
										          <div class="col-xs-6 col-sm-6 col-md-6">
										               <a class="btn btn-danger" href="/user_home" value="Cancel"> Cancel </a tabindex="13">
										          </div>
