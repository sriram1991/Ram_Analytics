...
<section class="content-header">
  <h4>
    <p><?php if(isset($user_details)) { echo $user_details['user_type']; }?> Offline Payment</p>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">   
                                  <div class="form-group control-group">
                                      <div class="control">
                                          <input type="text" required="" autocomplete="off" name="challan_no" id="challan_no" class="form-control input" placeholder="Enter Chalan No | Cheque No" tabindex="2" aria-required="true">
                                      </div>
                                      <span class="help-block"></span>
                                    </div>
                                </div>
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-xs-6 col-sm-2 col-md-2">
                                    <div class="form-group control-group">
                                        <div class="control">
                                            <button class="btn btn-success" type="button" onclick="offline_payment();"><i class="fa fa-credit-card"></i> Submit</button><br>
                                        </div>
                                    </div>
                                </div>
