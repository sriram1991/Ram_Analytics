        ...
        <section class="content">
                    ...
                    if(isset($resource_list)){
                        foreach ($resource_list as $res) {
                            ...
                            if($res_type == 'PDF'){
                                ...
                                onClick='associate_open_pdf(this.getAttribute(\"data-course_id\"),this.getAttribute(\"data-subject_name\"),this.getAttribute(\"data-resource_id\"),this.getAttribute(\"data-resource_link\"));'>
                                ...
                                echo "
                                <div class='small-box bg-aqua' 
                                onClick='associate_open_pdf(\"$course_id\",\"$module\",\"$group\",\"$subject_name\",\"$resource_id\",\"$resource_link\");'>
                                    <div class='inner'><h4>".$title."</h4><p>".$module." | ".$group."</p></div>
                                    <div class='icon'><i class='icon-file-pdf icon-size'></i></div>
                                    <a href='#'' class='small-box-footer'> Read <i class='fa fa-arrow-circle-right'></i></a>
                                </div>    
                            ...
                            if($res->resource_type == 'VIDEO'){
                                ...
                                data-resource_id=".htmlspecialchars($resource_id)."
                                data-resource_link=".htmlspecialchars($resource_link)."
                                onClick='associate_open_video(this.getAttribute(\"data-course_id\"),this.getAttribute(\"data-subject_name\"),this.getAttribute(\"data-resource_id\"),this.getAttribute(\"data-resource_link\"));'>
                                    <div class='inner'><h4>".$title."</h4><p>".$module." | ".$group."</p></div>
                                ...
                                echo "
                                <div class='small-box bg-aqua' 
                                onClick='associate_open_video(\"$course_id\",\"$module\",\"$group\",\"$subject_name\",\"$resource_id\",\"$resource_link\");'>
                                    <div class='inner'><h4>".$title."</h4><p>".$module." | ".$group."</p></div>
                                    <div class='icon'><i class='icon-movie-play-1 icon-size'></i></div>
                                    <a href='#'' class='small-box-footer'> Watch <i class='fa fa-arrow-circle-right'></i></a>
                                </div>    
                            ...
                            if($res->resource_type == 'CAPTIVA'){
                                ...
                                data-resource_id=".htmlspecialchars($resource_id)."
                                data-resource_link=".htmlspecialchars($resource_link)."
                                onClick='associate_open_captiva(this.getAttribute(\"data-course_id\"),this.getAttribute(\"data-subject_name\"),this.getAttribute(\"data-resource_id\"));'>
                                    <div class='inner'><h4>".$title."</h4><p>".$module." | ".$group."</p></div>
                                    <div class='icon'><i class='icon-movie-play-1 icon-size'></i></div>
                                    <a href='#'' class='small-box-footer'> Watch <i class='fa fa-arrow-circle-right'></i></a>
                                </div>    
                                ...
                                echo "
                                <div class='small-box bg-aqua' 
                                onClick='associate_open_captiva(\"$course_id\",\"$module\",\"$group\",\"$subject_name\",\"$resource_id\");'>
                                    <div class='inner'><h4>".$title."</h4><p>".$module." | ".$group."</p></div>
                                    <div class='icon'><i class='icon-movie-play-1 icon-size'></i></div>
                                    <a href='#'' class='small-box-footer'> Watch <i class='fa fa-arrow-circle-right'></i></a>
                                </div>    
                            ...
                            if($res->resource_type == 'CAPTIVA_QUIZ'){
                                ...
                                data-resource_id=".htmlspecialchars($resource_id)."
                                data-resource_link=".htmlspecialchars($resource_link)."
                                onClick='associate_open_captiva_quiz(this.getAttribute(\"data-course_id\"),this.getAttribute(\"data-subject_name\"),this.getAttribute(\"data-resource_id\"));'>
                                    <div class='inner'><h4>".$title."</h4><p>".$module." | ".$group."</p></div>
                                    <div class='icon'><i class='icon-movie-play-1 icon-size'></i></div>
                                    <a href='#'' class='small-box-footer'> Watch <i class='fa fa-arrow-circle-right'></i></a>
                                </div>    
                                ...
                                echo "
                                <div class='small-box bg-aqua' 
                                onClick='associate_open_captiva_quiz(\"$course_id\",\"$module\",\"$group\",\"$subject_name\",\"$resource_id\");'>
                                    <div class='inner'><h4>".$title."</h4><p>".$module." | ".$group."</p></div>
                                    <div class='icon'><i class='icon-movie-play-1 icon-size'></i></div>
                                    <a href='#'' class='small-box-footer'> Watch <i class='fa fa-arrow-circle-right'></i></a>
                                </div>    
            ...
            if(isset($assessment_list)){
                ...
                foreach($assessment_list as $res) {
                    ...
                    $small_box = "
                        <div class='small-box bg-green' onClick='associate_open_test_page(".$course_id.",\"$module\",\"$group\",\"$subject_name\",".$test_id.",\"$test_name\");'>
