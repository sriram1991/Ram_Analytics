        ...
        <section class="content">
            ...
            <div role="tabpanel">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#course" onClick="get_course_list();" aria-controls="course" role="tab" data-toggle="tab">Course</a></li>
                    <li role="presentation"><a href="#subject" onClick="get_subject_list();" aria-controls="subject" role="tab" data-toggle="tab">Area of Interest's</a></li>
                    <!-- <li role="presentation"><a href="#course_syllabus" onClick="open_course_syllabus();" aria-controls="course_syllabus" role="tab" data-toggle="tab">Course Syllabus</a></li> -->
                    <!-- <li role="presentation"><a href="#resource" onClick="get_resource_list();" aria-controls="resource" role="tab" data-toggle="tab">Resource</a></li> -->
                    ...
                    <!-- <li role="presentation"><a href="#batch" onClick="get_batch_list();" aria-controls="batch" role="tab" data-toggle="tab">Batch</a></li> -->
                </ul>
                <!-- Nav tabs -->
                ...
                <div class="tab-content">
                    ...
                    <!-- Course Syllabus -->
                    <div role="tabpanel" class="tab-pane" id="course_syllabus">
                        
                        <!-- Course Syllabus View Page in Ajax -->
