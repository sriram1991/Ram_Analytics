...
<!-- Styles Ended  -->
  ...
  <div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <div class="container"><!-- /.container -->
      ...
      <?php echo form_open_multipart('/register/affilate',$attr);?>
      
      <!-- Panel Design Start -->
      <div class="panel panel-info">
        <div class="panel-heading"><div class="panel-title"><h4>Affiliate Registration</h4></div></div>
      <!-- </div> -->
          ...
          <div class="col-xs-12 col-sm-6 col-md-6"><!-- OUTER Col Begin-->
            <fieldset>
              ...
              <div class="row">
                ...
                <!-- Disable the Course Selsction
                <div class="col-xs-12 col-sm-6 col-md-4">
                  <div class="form-group control-group">
                    <div class="control">
                    <select name="corse" autocomplete="off" id="corse" class="form-control input" size="1" placeholder="State" tabindex="16">
                        <option value="" selected="">Select Course</option>
                        <option value="IIT Crash Course">IIT Crash Course</option>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8">
                      <div class="form-group control-group">
                        <div class="control">
                          <input type="file" name="profile_picture" id="profile_picture" class="form-control input" placeholder="Upload Photo" tabindex="16"> 
                        </div>
                        <span class="help-block"></span>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                      <div class="form-group control-group">
                        <div class="control input-group">
                          <input type="checkbox" id="skol_terms" name="skol_terms" required="" tabindex="17"> 
                            I accept <a data-toggle="modal" data-target="#terms-modal" tabindex="18">Terms and Conditions </a> of <?php echo PRODUCT_NAME; ?>
                        </div>
                        <span class="help-block"></span>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-3">
                      <div class="form-group control-group">
                          <div class="control">
                          <button type="button" class="btn btn-success" onClick="doSubmit('#studentRegistrationFrom');" tabindex="19">
          ...
          <div class="modal-body">
            ...
            <div style="width: 100%; padding-right: 5%;">
              <ol>
                <li> 
                  <p align="justify">                
                    After depositing money for the admission-cum-scholarship test or course fee, if a student fails to join classes in the institute for any reason
