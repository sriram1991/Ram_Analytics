        ...
        <script type="text/javascript"> var students_id = $('#state').val(); </script>        
                <button type="button" class="btn btn-primary"  onclick="tableToExcel('batchwise_list','Skol Table','User_batchwise_'+students_id+'_report.xlsx')">Download</button>        
