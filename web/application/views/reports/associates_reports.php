        ...
        <section class="content">
            ...
            <div role="tabpanel">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#associates" onClick="get_unverified_associates();" aria-controls="resource" role="tab" data-toggle="tab">SPOC List</a></li>
                    <!-- <li role="presentation"><a href="#students" onClick="get_unverified_students();" aria-controls="assessment" role="tab" data-toggle="tab">Student List</a></li> -->
