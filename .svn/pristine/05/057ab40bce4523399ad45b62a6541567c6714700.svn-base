      ...
      <!--  <div class="content-footer"> -->
            <center>
              ...
              if($test_date < $todays_date){
                echo "<button type='button' class='btn btn-success' onClick='associate_open_question_paper(".$course_id.",\"$subject_name\",".$test_id.",\"$test_name\");' tabindex='4'>View Question Paper</button>";
                echo"&nbsp";
                echo"&nbsp";
                echo "<button type='button' class='btn btn-success'onClick='associate_show_answer_key(".$course_id.",\"$subject_name\",".$test_id.",\"$test_name\");' >Show Answer Key </button>";
              } else{
                echo "<button type='button' class='btn btn-success' onClick='associate_open_question_paper(".$course_id.",\"$subject_name\",".$test_id.",\"$test_name\");' tabindex='4'>View Question Paper</button>";
              }
