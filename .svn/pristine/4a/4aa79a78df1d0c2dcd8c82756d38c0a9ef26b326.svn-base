                    ...
                    <?php 
                        if(isset($course_details)){
                            if($course_details['course_syllabus_file'] != 'NULL'){
                                ...
                                echo "<button class='btn btn-primary' onClick='get_student_course_syllabus(\"$course_id\",\"$syllabus_file\");'>View Syllabus</button>";
                            }
                        }
                    ?>
                        ...
                        foreach ($course_module as $res) {
                            ...
                            $small_box  = "
                                <div class='small-box bg-purple'
                                     ...
                                     onClick='get_course_groups(this.getAttribute(\"data-course_id\"),this.getAttribute(\"data-module_name\"));' >
                            ...
                            //          onClick='get_student_course_groups(\"$course_id\",\"$module_name\");' >
                            //         <div class='inner'><h4>".$module_name."</h4><p>".$publish_date."</p></div>
                            //         <div class='icon'><i class='ion-social-rss'></i></div>
                            //         <a href='#'' class='small-box-footer'>See Groups <i class='fa fa-arrow-circle-right'></i></a>
                            //     </div>    
                            //     "; 
                            echo "
                                <div class='small-box bg-green'
