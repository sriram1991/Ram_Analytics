<form method="post" action="#" id="ajax_mentor_audio_upload" name="ajax_mentor_audio_upload">
	<div class="row">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="form-group control-group">
                <div class="control">
                    <input type="file" required autocomplete="off" name="resource_audio_link" id="resource_audio_link" class="form-control input" placeholder="Select File" tabindex="3"> 
                </div>
                <span class="help-block"></span>
            </div>
        </div>
    ...
    <input id="file_type" type="hidden" value="AUDIO">
<!-- <input type="file" name="userfile" id="userfile" size="20" /> -->
</form>
<script src="/static/js/common/ajaxfileupload.js"></script>
<script src="/static/js/common/ajax_audio_file_upload.js"></script>
