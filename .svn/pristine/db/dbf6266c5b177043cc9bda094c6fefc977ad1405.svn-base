          ...
          <div class="col-xs-12 col-sm-6 col-md-6"> <!-- OUTER Col Start -->
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                  <div class="form-group control-group">
                    <div class="control input-group">
                      <input type="text" autocomplete="off" name="city" id="city" class="form-control input" placeholder="City" tabindex="7">
                    </div>
                    <span class="help-block"></span>
                  </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                  <div class="form-group control-group">
                    <div class="control">
                      <input type="text" autocomplete="off" name="pincode" id="pincode" class="form-control input" placeholder="Pincode / Zip" tabindex="8">
                    </div>
                    <span class="help-block"></span>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-5">
                  <div class="form-group control-group">
                      <div class="control">
                      <select name="country" autocomplete="off" id="country" class="form-control input" size="1" placeholder="Country" tabindex="9">
                ...
                <div class="col-xs-12 col-sm-6 col-md-5">
                  <div class="form-group control-group">
                    <div class="control">
                      <select name="state" autocomplete="off" id="state" class="form-control input" size="1" placeholder="State" tabindex="10">
              ...
              <input type="hidden" value="3" data-role='SPOC' id="user_role" name="user_role"></input>
             ...
             <div class="col-xs-12 col-sm-6 col-md-6"><!-- OUTER Col Begin-->
              ...
              <div class="row">
                ...
                <div class="col-xs-6 col-sm-12 col-md-12">
                  <div class="form-group control-group">
                    <div class="control">
                      <textarea id="letter_of_intent" name="letter_of_intent" class="form-control" rows="3" title="Please fill SPOC NAME' " tabindex="13">I "SPOC NAME" Submit my application for SPOC program with your organization
 acceptation and having gone through the company Terms & Conditions.
