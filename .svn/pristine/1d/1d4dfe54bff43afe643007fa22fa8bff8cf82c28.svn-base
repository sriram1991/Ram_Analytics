<link rel="stylesheet" type="text/css" href="/static/css/common/student_reg_form.css">
    ...
    <form method="POST" name="EditRegistrationForm" id="EditRegistrationForm"  action="#" role="form">
      ...
      <div class="panel panel-info">
        <div class="panel-heading"><div class="panel-title"><h4>Edit User Registration</h4></div></div>
      </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12"><!-- OUTER Col Begin-->
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                  <div class="form-group control-group">
                    <div class="control">
                    <textarea autocomplete="off" name="edit_address" id="edit_address"  class="form-control input-large" tabindex="11" placeholder="Street Address"><?php echo $user_details['user_address'];?></textarea>
                    </div>
                    <span class="help-block"></span>
                  </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                  <div class="form-group control-group">
                    <div class="control input-group">
                    <input type="text" autocomplete="off" name="edit_city" id="edit_city" value ="<?php echo $user_details['user_city'];?>" class="form-control input" placeholder="City" tabindex="12">
                    </div>
                    <span class="help-block"></span>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                  <div class="form-group control-group">
                      <div class="control">
                      <input type="text" autocomplete="off" name="edit_country" id="edit_country" value ="<?php echo $user_details['user_country'];?>"  class="form-control input" placeholder="Country" tabindex="14">
                      </div>
                      <span class="help-block"></span>
                  </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                  <div class="form-group control-group">
                      <div class="control">
                      <input type="text" autocomplete="off" name="pincode" id="pincode" value ="<?php echo $user_details['user_pin'];?>" class="form-control input" placeholder="Pincode / Zip" tabindex="15">
                      </div>
                      <span class="help-block"></span>
                  </div>
                </div>
