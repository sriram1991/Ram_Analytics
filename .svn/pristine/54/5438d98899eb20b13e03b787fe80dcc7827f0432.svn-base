...
(function($) {
    ...
    $.ownage.Loader = function(el, params, selector, number) {
        ...
        base.preloadImages = function() {
            var images = [
                '/static/js/jquery-oLoader/images/ownageLoader/loader1.gif',
                '/static/js/jquery-oLoader/images/ownageLoader/loader2.gif',
                '/static/js/jquery-oLoader/images/ownageLoader/loader3.gif',
                '/static/js/jquery-oLoader/images/ownageLoader/loader4.gif',
                '/static/js/jquery-oLoader/images/ownageLoader/loader5.gif',
                '/static/js/jquery-oLoader/images/ownageLoader/loader6.gif',
                '/static/js/jquery-oLoader/images/ownageLoader/loader7.gif'
            ];
