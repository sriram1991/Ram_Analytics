        <div class="sometype">
         <br>
            <div class="btn-group" role="group">
                <button type="button" class="btn btn-primary icon-students" data-toggle="modal" data-target="#addAffilateModal" onClick="add_affilate_modal();" >
                  Add Affiliate
                </button>
            </div>
        </div> <br>
        ...
        <div class="box">
            ...
            <div class="box-body table-responsive">
                ...
                <table id="affilates_list" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>SL.NO</th>
                    ...
                    <tbody>
                        <?php  
                            ...
                            foreach ($affilates_details as $res) {
                                echo "<tr>";
                                echo "<td>".$count++."</td>";
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" onClick="register_user('#associateRegistrationFrom');" id='add_user_btn' data-loading-text="Processing..." >Add Affiliate</button>
    ...
    <!-- ============= Affiliate Enrolled Users list Modal =========== -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Affiliate Users List</h4>
                </div>
    ...
    <!-- ============= Affiliate Enrollment list Modal =========== -->