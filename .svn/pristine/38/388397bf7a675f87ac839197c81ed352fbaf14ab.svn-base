...
<form method="POST" action="#" name="ass_file_upload" id="ass_file_upload" role="form">
    <div class="row">
 ...
 <script src="/static/js/common/ajax_assessment_upload.js" type="text/javascript"></script>
