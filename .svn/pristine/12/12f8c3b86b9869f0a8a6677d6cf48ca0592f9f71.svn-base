<form method="post" action="#" id="ajax_file_upload" name="ajax_file_upload">
	<div class="row">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
            <div class="form-group control-group">
                <div class="control">
                    <input type="file" required autocomplete="off" name="resource_link" id="resource_link" class="form-control input" placeholder="Select File" tabindex="3"> 
                </div>
                <span class="help-block"></span>
            </div>
        </div>
...
<script src="/static/js/common/ajax_pdf_upload.js"></script>
