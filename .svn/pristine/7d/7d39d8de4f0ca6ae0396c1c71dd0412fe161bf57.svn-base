   <br> <div class="row">
            <div class="col-xs-12 col-sd-6 col-md-6">
                <div class="box box-danger">
                    <div class="box-header">
                        ...
                        <h3 class="box-title">Child monthly test graph</h3>
                    </div>
        ...
        <script type="text/javascript">
            ...
            var stu_jun = "<?php if(isset($stu_jul)) echo $stu_jun; else null; ?>";
            if(stu_jun=='')
                stu_jun =null;
            ...
            // alert(stu_jan+"-"+stu_feb+"-"+stu_mar+"-"+stu_apr+"-"+stu_may+"-"+stu_jun+"-"+
