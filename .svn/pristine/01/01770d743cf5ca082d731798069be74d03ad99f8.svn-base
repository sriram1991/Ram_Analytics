                        ...
                        <div class="sometype">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                  ...
                                  <li><a href="#" data-toggle="modal" data-target="#addCaptivaQuizRes" onClick="ajax_captiva_quiz_request();" >Captiva Quiz</a></li>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body table-responsive">
                                ...
                                <table id="resource_list" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>SL.NO</th>
                                            <th>Resource Name</th>
                        ...
                        <!-- ============= ADD Captiva Quize Modal =========== -->
                        <div class="modal fade" id="addCaptivaQuizRes" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel"> Add Captiva Quiz Resource Zip</h4>
                                    </div>
                                    
                                    <div class="modal-body" id="body-add_captiva_quiz">
